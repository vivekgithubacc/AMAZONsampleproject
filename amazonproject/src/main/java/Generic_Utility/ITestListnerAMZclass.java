...
public class ITestListnerAMZclass implements ITestListener 
{
	...
	htmlreport.config().setDocumentTitle("AMAZON Report");
	...
	report.setSystemInfo("URL", "https://www.amazon.in/");
